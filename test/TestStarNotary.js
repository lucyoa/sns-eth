...
it('can add the star name and star symbol properly', async() => {
    ...
    let instance = await StarNotary.deployed();
    await instance.createStar('New Star', 10, {from: accounts[0]});
...
it('lets 2 users exchange stars', async() => {
    ...
    let starId1 = 101
    let starId2 = 102
    await instance.createStar('Star number 1', starId1, {from: user1});
    await instance.createStar('Star number 2', starId2, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    let starId = 200;
    await instance.createStar('Beautiful Star', starId, {from: user1});
